...
def generate_from_file(input_path: Path):
    ...
    candidate = build_candidate_pick(engine_output, kickoff_datetime=adapted.get("kickoff_datetime"), odds=None, edge_raw=None, expiry_context="pre_match_same_day")
