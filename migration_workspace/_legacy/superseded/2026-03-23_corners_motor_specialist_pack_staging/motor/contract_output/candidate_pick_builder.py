...
def build_candidate_pick(corners_output, module_version="corners.motor_specialist", kickoff_datetime=None, odds=None, edge_raw=None, expiry_context="pre_match_same_day"):
