...
def infer_internal_rank(score):
    ...
    return 5
def build_candidate_pick(corners_output, module_version='corners.official_trunk_calibrated', kickoff_datetime=None, odds=None, edge_raw=None, expiry_context='pre_match_same_day'):
