...
def _bvs(t):
    cs_inv = 1 - t.clean_sheet_rate
    return _clamp(24*t.goals_against_90 + 18*min(100.0, t.shots_on_target_against_90/6.0*100)/100 + 10*min(100.0, t.shots_against_90/16*100)/100 + 16*t.concede_rate_1plus + 6*cs_inv + 4*(t.home_away_defense_split/100))
...
def _fgt(t):
    deadlock = 100*t.halftime_0_0_rate
    early = 100*t.first_goal_u30_rate
    first_half = 100*t.first_half_goal_rate
    response = 100*t.response_after_concede_rate
    both_halves = 100*t.goals_both_halves_rate
