...
def build_candidate_pick(corners_output, module_version="corners.confidence_risk_refinement", kickoff_datetime=None, odds=None, edge_raw=None, expiry_context="pre_match_same_day"):
    return map_corners_output_to_market_pick(
        ...
        odds=odds,
        edge_raw=edge_raw,
        module_rank_internal=infer_internal_rank(float(corners_output.get("score", 0.0))),
