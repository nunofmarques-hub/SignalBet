...
def build_candidate_pick(corners_output: dict, *, module_version="corners.preintegracao", kickoff_datetime=None, odds=None, edge_raw=None, expiry_context="pre_match_same_day"):
