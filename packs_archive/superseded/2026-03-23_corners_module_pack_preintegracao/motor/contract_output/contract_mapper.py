...
def parse_market_label(label: str):
...
def build_data_quality_flag(eligibility: bool, alerts: list[str]) -> str:
    ...
    if "contradit" in lowered:
        return "fragile"
    if "fronteira" in lowered:
        return "partial"
    return "clean"

def map_corners_output_to_market_pick(corners_output: dict, *, module_version: str, kickoff_datetime=None, odds=None, edge_raw=None, module_rank_internal=None, expiry_context=None) -> dict:
