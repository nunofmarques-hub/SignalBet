...
def map_corners_output_to_market_pick(corners_output, module_version='corners.staging', kickoff_datetime=None, odds=None, edge_raw=None, module_rank_internal=1, expiry_context=None):
    parts = str(corners_output['market']).split()
    direction = parts[0]
    line = float(parts[1])
