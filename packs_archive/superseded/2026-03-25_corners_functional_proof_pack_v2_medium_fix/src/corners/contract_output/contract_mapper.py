...
def map_corners_output_to_market_pick(corners_output, module_version="corners.functional_proof_v2"):
    ...
    return {
        ...
        "data_quality_flag": "clean" if corners_output["eligible"] else "invalid",
        ...
        "module_specific_payload": {
            ...
            "candidate_status": corners_output["candidate_status"],
            "band": corners_output["band"],
            "rationale": corners_output["rationale"],
